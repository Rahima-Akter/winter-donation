...
const About = () => {
    return (
        <>
            <section className="flex flex-col lg:flex-row items-center lg:items-center gap-12 px-6 py-10 mb-10 w-10/12 mx-auto">
                ...
                {/* Image Container */}
                <div className="lg:w-[42%] lg:order-2 order-1 relative overflow-hidden">
                    <img
